...
if __name__ == '__main__':
    ...
    plt.show()
    plt.savefig("../../reports/figures/full_finetuning_train_loss.png", dpi=300, bbox_inches='tight')
    plt.figure()

    plt.plot(train_acc)
    plt.title('Finetune Classification Train Accuracy')
    plt.savefig("../../reports/figures/full_finetuning_train_acc.png", dpi=300, bbox_inches='tight')
    plt.show()
    plt.figure()

    plt.plot(all_val_acc)
    plt.title('Finetune Classification Val Accuracy')
    plt.savefig("../../reports/figures/full_finetuning_val_acc.png", dpi=300, bbox_inches='tight')
    plt.show()